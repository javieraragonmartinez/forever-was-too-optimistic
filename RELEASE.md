...
The committed PDF must have 43 pages and be compiled from the committed TeX source. The DOI remains reserved until the external archive is published and its files are compared with this release.
